            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="footer_area_about">
                        <img src="imagengo1.png" alt="img" width="75px" height="75px">
                        ...
                        <h6><strong>Email:</strong> <a href="mailto:info@example.com">Helping NGO@example.com</a></h6>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="co-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright_left"> 
                        <p>Copyright Helping Ngo ©  2022 All Rights Reserved</p>
                    </div>
                </div>
                <div class="co-lg-6 col-md-6 col-sm-12 col-12">
